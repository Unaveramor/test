...
<div class="navbar navbar-dark bg-dark shadow-sm">
  ...
  <a href="{{route('home')}}" class="navbar-brand d-flex align-items-center">
    ...
    stroke-linejoin="round" stroke-width="2" aria-hidden="true" class="me-2" viewBox="0 0 24 24"><path 
    d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"></path><circle cx="12" cy="13" r="4">
