...
@vite(['resources/js/js/bootstrap.js'])
<style>
  .bd-placeholder-img {
    font-size: 1.125rem;
    text-anchor: middle;
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-8 col-md-7 py-4">
        <h4>About</h4>
        @auth
        <p class="text-body-secondary">Привет, </p>
        @endauth
      </div>
        ...
        <ul class="list-unstyled">
          @auth
            <a href="#">
              {{ auth()->user()->name }}
              @if (auth()->user()->avatar)
                <img src="{{ asset('public/storage/images/' . auth()->user()->avatar) }}" alt="" height="40">
              @endif
            </a>
          ...
          <li><a href="{{route('login.create')}}" class="text-white">авторизация</a></a></li>
          @endguest
